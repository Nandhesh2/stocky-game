...
with tab1:
    ...
    st.subheader("| Github")
    st.write(
        '<p style="color:#9c9d9f">Create your own dungeon! Visit <a href="https://github.com/Nandhesh2/stocky-game">GitHub</a>. Edit your levels with <a href="https://dungeon-editor.streamlit.app/">The Dungeon editor</a>.</p><br>',
        unsafe_allow_html=True,
    )
